...
signal_files = ["Ld10_rho20_pi5_Zp600_l5.root", "Ld10_rho20_pi5_Zp600_l50.root", "Ld40_rho80_pi20_Zp600_l5.root", "Ld40_rho80_pi20_Zp600_l50.root"]  # Add paths to your signal files
background_file = "QCD_EJ.root"  # Path to your background file

# Histogram path in the ROOT file
histogram_path = "CR2Tag_EJ/n_emerging_jet"
...
def get_second_bin_content(file_path, hist_path):
    with uproot.open(file_path) as root_file:
        ...
        return bin_contents[2]  # Index 1 corresponds to the 2nd bin
...
for signal_file in signal_files:
    ...
    sb_ratios[signal_file] = sb_ratio
